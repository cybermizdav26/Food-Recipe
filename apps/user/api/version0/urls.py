...
from apps.user.api.version0.views import (
    user_create, user_update, following_create,
    user_login, followers_list, following_list,
    user_profile, verify_code, change_password,
